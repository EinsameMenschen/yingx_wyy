...
public class AliyunOssUtil {
    ...
    private static String accessKeyId = "LTAI4GEJBXgRgXWC4HfQyybt";
    private static String accessKeySecret = "y0Oi2TxMyMyV8g8t1n0R57BeJAFbqg";
    //yourBucktName
    private static String bucketName = "yingx-wyy";  //存储空间名
    /*
    * 上传本地文件
    * 参数：
    * fileName:上传的文件名
