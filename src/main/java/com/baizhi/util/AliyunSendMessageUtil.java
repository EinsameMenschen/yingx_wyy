...
//替换成你的AK
        final String accessKeyId = "LTAI4GEJBXgRgXWC4HfQyybt";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "y0Oi2TxMyMyV8g8t1n0R57BeJAFbqg";//你的accessKeySecret，参考本文档步骤2
...
//请求成功
    ...
    public static String sendCode(String phoneNumber,String code){
        String signName="二丫";
        String templateCode="SMS_200693896";
