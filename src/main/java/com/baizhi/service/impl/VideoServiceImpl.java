...
public class VideoServiceImpl implements VideoService {
    ...
    public HashMap<String, Object> delete(Video video) {
        ...
        /*
          https://yingx-wyy.oss-cn-beijing.aliyuncs.com/video/1598581090384-1.mp4
        * 1598581090384-1.mp4
        * */
            String[] split = path.split("/");//拆分字符串。通过指定分隔符对字符串进行切片
    ...
    public List<Video> querySearch(String content) {
        ...
        NativeSearchQuery build = new NativeSearchQueryBuilder()
                ...
                .build();
        List<Video> videos = template.queryForList(build, Video.class);
        return videos;
    }
