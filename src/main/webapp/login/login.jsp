    ...
    <script>
        $(function(){
            ...
            $("#captchaImage").click(function(){
                $("#captchaImage").prop("src","${path}/code/code?r="+Math.random());
            })
            /*添加表单验证*/
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <span style="color: #c9302c">${requestScope.errormsg}</span>
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            <span id="msgDiv"></span>
                            <div class="form-group">
                                <label class="sr-only" for="form-username">Username</label>
                                <input type="text" id="name" name="username" placeholder="请输入用户名..." class="form-username form-control" required id="form-username" onblur="change()"><span id="sname" style="color:red"></span></td>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="test" name="image" id="form-code">
                            </div>
