        ...
        $("#video-show").jqGrid(
            {
                ...
                colModel : [
                    ...
                    {name : 'path',editable:true,width : 180,align : "center",edittype:"file",formatter:function(cellvalue, options, rowObject){
                            //return "<img width='100px' height='70px' src='${path}/bootstrap/img/"+cellvalue+"'>";
                            return "<video width='400px' height='120px' src=\""+cellvalue+"\" controls poster='"+rowObject.cover+"'/>";
                    }},
