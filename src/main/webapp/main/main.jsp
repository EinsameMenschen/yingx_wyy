 ...
 <nav class="navbar navbar-default">
     <div class="container-fluid">
         ...
         <ul class="nav navbar-nav navbar-right">
             ...
             <li><a href="${path}/admin/safeOut">退出<span class="glyphicon glyphicon-log-out" style="color: #3e8f3e"></span></a></li>
         </ul>
     </div><!-- /.container-fluid -->
 </nav>
 <!--栅格系统-->
                     ...
                     <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                         <div class="panel-body">
                             <ul class="nav nav-pills nav-stacked">
                                 ...
                                 <li><a class="btn btn-info" href="javascript:$('#MainId').load('${path}/echart-goeasy/echarts1.jsp')">用户统计</a></li>
                                 <li><a class="btn btn-info" href="javascript:$('#MainId').load('${path}/echart-goeasy/echarts-map1.jsp')">用户分布</a></li>
                             </ul>
                         </div>
                     </div>
                 </div>
                     ...
                     <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                         <div class="panel-body">
                             <ul class="nav nav-pills nav-stacked">
                                 ...
                                 <li><a class="btn btn-success" href="javascript:$('#MainId').load('${path}/video/findVideo.jsp')">搜索视频</a></li>
                             </ul>
                         </div>
                     </div>
                 </div>
             ...
             <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                 ...
                 <div class="carousel-inner" align="center" role="listbox">
                     <div class="item active">
                         ...
                         <!-- <video src="
https://yingx-wyy.oss-cn-beijing.aliyuncs.com/video/1.mp4" controls  poster="https://yingx-wyy.oss-cn-beijing.aliyuncs.com/photo/2.jpg"  width="400px" height="150px"></video>-->
